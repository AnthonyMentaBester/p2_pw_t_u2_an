...
public class Main {
	...
	public static void main(String[] args) {
		...
		IPersonaPredicate<String> predicate3 = caracter -> {
			...
			IPersonaFunction<String, Integer> functionn = metodos::transformar;
			LOG.info("metodo refenciado function  : " +  functionn.aplicar(8));
			
			IPersonaUnaryOperator<Integer> unaryOperatorr = metodos::sumar;
			LOG.info("metodo refenciado unary operator  : " +  unaryOperatorr.aplicar(8));
